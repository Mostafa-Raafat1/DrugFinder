        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DomainGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PharmacyId", x => x.DBId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PatientId", x => x.DBId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("DrugRequestId", x => x.DBId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("NotificationId", x => x.DBId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PharmacyResponseId", x => x.DBId);
                    table.ForeignKey(
                        name: "FK_PharmacyResponses_DrugRequests_DrugRequestId",
                        column: x => x.DrugRequestId,
                        principalTable: "DrugRequests",
                        principalColumn: "DBId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PharmacyResponses_Pharmacies_PharmacyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DrugRequests_DomainGuid",
                table: "DrugRequests",
                column: "DomainGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DrugRequests_PatientId",
                table: "DrugRequests",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_DomainGuid",
                table: "Notifications",
                column: "DomainGuid",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_DomainGuid",
                table: "Patients",
                column: "DomainGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Pharmacies_DomainGuid",
                table: "Pharmacies",
                column: "DomainGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyResponses_DomainGuid",
                table: "PharmacyResponses",
                column: "DomainGuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyResponses_DrugRequestId",
                table: "PharmacyResponses",
                column: "DrugRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_PharmacyResponses_PharmacyId",
                table: "PharmacyResponses",
                column: "PharmacyId");
        }
